...
#script to run MAGMA gene property analysis - all sites

#set variables 
folder="data"
file="update_EUR.CD.gwas_info03_filtered.assoc"
outfile_conti="helm_batch1_13_gca_conti_spe_2025"
covar_file_conti="data/gca_conti_specificity_matrix.txt"
