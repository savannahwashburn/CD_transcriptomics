...
#read in significant results - colon
df_cond <- read_table(file = "/Users/swashburn30/Desktop/Helmsley_Project/Batch1_13/MAGMA_analysis/data/helm_batch1_13_colon_joint_spe_sig.gsa.out", skip=4) %>% 
