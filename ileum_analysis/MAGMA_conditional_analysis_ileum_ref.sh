...
#script to run MAGMA conditional analysis - ileum reference

#set variables 
folder="data"
file="update_EUR.CD.gwas_info03_filtered.assoc"
covar_file_spe="helm_batch1_13_ileum_ref_conti_matrix_sig"
out_file_spe="helm_batch1_13_ileum_ref_joint_spe_sig"
