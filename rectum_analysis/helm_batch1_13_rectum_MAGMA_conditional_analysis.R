...
#read in significant results - rectum, relaxed 
df_cond <- read_table(file = "/Users/swashburn30/Desktop/Helmsley_Project/Batch1_13/MAGMA_analysis/data/helm_batch1_13_rectum_joint_spe_sig.gsa.out", skip=4) %>% 
...
n_sig <- ceiling(sqrt(nrow(df_cond))) #7
